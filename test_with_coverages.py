...
commands = [command1, command1_monkey, command1, command1_monkey,  command1, command1_monkey,  command1, command1_monkey,  command1, command1_monkey,  command1, command1_monkey,  command1, command1_monkey,  command1, command1_monkey,  command1, command1_monkey,  command1, command1_monkey]
